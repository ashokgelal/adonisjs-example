...
const standalone_1 = require("@adonisjs/env/build/standalone");
/**
...
class EnvParser {
    ...
    async parse(rootDir) {
        try {
            this.envContents = standalone_1.env.parse(await fs_extra_1.readFile(path_1.join(rootDir, '.env'), 'utf-8'));
        }
        catch {
        }
    }
