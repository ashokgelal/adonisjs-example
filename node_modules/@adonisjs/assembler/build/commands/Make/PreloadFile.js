...
class MakePreloadFile extends Base_1.BaseGenerator {
    ...
    async handle() {
        ...
        const rcFile = new files.AdonisRcFile(env_1.ADONIS_ACE_CWD());
...
MakePreloadFile.description = 'Make a new preloaded file. Preloaded files are loaded automatically on boot';
__decorate([
    ace_1.args.string({ description: 'Name of the file' }),
