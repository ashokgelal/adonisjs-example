 ...
 */
export declare function compileRule(type: string, subtype: string, rule: Rule): ParsedRule;
/**
 ...
 */
export declare function getObjectType(isOptional: boolean, children: ParsedSchemaTree, rules: Rule[]): {
